...
public:
    ...
    static bool ToBit8(const char* str, char* value);
    static bool ToBit16(const char* str, short* value);
    static bool ToBit32(const char* str, int* value);
    static bool ToBit64(const char* str, long long* value);
...
public:
    ...
    */
    ...
    char	 Bit8Value() const {
        char f = 0;
        QueryBit8Value(&f);
        return f;
    }
    short	 Bit16Value() const {
        short f = 0;
        QueryBit16Value(&f);
        return f;
    }
    int	 Bit32Value() const {
        int f = 0;
        QueryBit32Value(&f);
        return f;
    }
    long long 	 Bit64Value() const {
        long long f = 0;
        QueryBit64Value(&f);
        return f;
    }
    ...
    */
    ...
    XMLError QueryBit8Value(char* bvalue) const;

    XMLError QueryBit16Value(short* bvalue) const;

    XMLError QueryBit32Value(int* bvalue) const;

    XMLError QueryBit64Value(long long* bvalue) const;
...
public:
    ...
    */
    XMLError QueryBit8Text(char* bval) const;

    XMLError QueryBit16Text(short* sval) const;

    XMLError QueryBit32Text(int * ival) const;

    XMLError QueryBit64Text(long long * lval) const;
    ...
    short Bit16Text() const;

    int Bit32Text() const;

    long long  Bit64Text() const;
	/// See QueryIntText()
